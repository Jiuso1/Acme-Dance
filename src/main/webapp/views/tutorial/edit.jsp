...
<form:form action="tutorial/editTutorial.do" method="POST" modelAttribute="tutorial">
	<form:hidden path="id" />
	...
	<form:input path="titulo" value="${tutorial.titulo}"/>
	...
	<form:input path="descripcion" value="${tutorial.descripcion}"/>
	...
	<form:input path="video" value="${tutorial.video}"/>
